            ...
            <div class="container">
                ...
                <div class="navbar-collapse">
                    <ul class="nav navbar-nav">
                        <li class=""><a href="diagnose_patient">Diagnose Patient</a></li>
                        <li class=""><a href="prescribe_patient">Prescribe Patient</a></li>
                        <li class=""><a href="view_patients">View Patients</a></li>
                    </ul>
