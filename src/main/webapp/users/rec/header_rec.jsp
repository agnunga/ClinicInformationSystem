            ...
            <div class="container">
                ...
                <div class="navbar-collapse">
                    <ul class="nav navbar-nav">
                        <li class=""><a href="/ClinicInformationSystem/receptionist/register_patient">Add Patient</a></li>
                        <li class=""><a href="/ClinicInformationSystem/receptionist/view_patients">View Patients</a></li>
                    </ul>
