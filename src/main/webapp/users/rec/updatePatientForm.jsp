			...
			<div class="col-md-4 inputGroupContainer">
				<div class="input-group">
					<span class="input-group-addon"><i
						...
						placeholder="Patient ID" value="<%=patient.getPatientId()%>"
						class="form-control" readonly="readonly" type="text" required maxlength="10">
				</div>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-md-4 inputGroupContainer">
				<div class="input-group">
					<span class="input-group-addon"><i
						...
						placeholder="National ID" value="<%=patient.getNationalId()%>"
						class="form-control" readonly="readonly" type="text" required maxlength="8">
				</div>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-md-4 inputGroupContainer">
				<div class="input-group">
					<span class="input-group-addon"><i
						...
						placeholder="Patient Name" value="<%=patient.getName()%>"
						class="form-control" type="text" required maxlength="40">
				</div>
			</div>
		</div>
		<div class="form-group">
